...
public final class ValidationStep<T> {
    ...
    /**
     * Executes all validation checks in the chain. If one of the checks fails, all other remaining checks will be executed. This enables building error messages
     * which contain all reasons why the given value is invalid and helps the customer to fix the parameters in as least circles as possible.
     *
